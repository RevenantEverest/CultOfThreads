...
function SocialsBar() {
    ...
    return(
        <div className="flex gap-10">
            <SocialIcon icon={FaEtsy} tooltip="Facebook" to={SOCIAL_LINKS.ETSY.url} size="7xl" />
            ...
            <SocialIcon icon={FaTiktok} tooltip="Instagram" to={SOCIAL_LINKS.TIK_TOK.url} size="7xl" />
        </div>
    );
};
