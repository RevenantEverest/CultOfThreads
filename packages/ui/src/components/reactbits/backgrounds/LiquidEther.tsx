  ...
  useEffect(() => {
    ...
    function makePaletteTexture(stops: string[]): THREE.DataTexture {
      ...
      if (Array.isArray(stops) && stops.length > 0) {
        arr = stops.length === 1 ? [stops[0] as string, stops[0] as string] : stops;
      } else {
        arr = ['#ffffff', '#ffffff'];
      }
      const w = arr.length;
    ...
    class MouseClass {
      ...
      onDocumentTouchStart(event: TouchEvent) {
        if (event.touches.length === 1) {
          ...
          if (this.onInteract) this.onInteract();
          this.setCoords(t?.pageX as number, t?.pageY as number);
          this.hasUserControl = true;
        }
      }
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (this.uniforms.dt && typeof dt === 'number') this.uniforms.dt.value = dt;
        if (typeof isBounce === 'boolean') this.line.visible = isBounce;
        if (this.uniforms.isBFECC && typeof BFECC === 'boolean') this.uniforms.isBFECC.value = BFECC;
        super.update();
      }
    }
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if(!uniforms.force || !uniforms.center || !uniforms.scale) return;
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (this.uniforms.v && typeof viscous === 'number') this.uniforms.v.value = viscous;
    ...
    class Divergence extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (this.uniforms && this.uniforms.velocity && vel) {
